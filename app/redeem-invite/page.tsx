  ...
  return (
    <main className="min-h-screen bg-[#080808] text-zinc-100 grid place-items-center px-6">
      <div className="iv-panel w-full max-w-md p-8">
        ...
        <h1 className="iv-title text-4xl">Already Purchased?</h1>
        <p className="iv-body mt-3 text-sm">
          Enter your access code. It is tied to your current signed-in account and restores the package purchased for you.
        </p>
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
          ...
          >
            {state.type === 'loading' ? 'Unlocking...' : 'Unlock Access'}
          </button>
        </form>
